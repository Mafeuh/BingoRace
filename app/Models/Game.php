...
class Game extends Model
{
    ...
    public static function getPublicGames() {
        return Game::where('is_public',  1)->where('visible', 1)->where('is_official', 0);
    }

    public static function getOfficialGames() {
        return Game::where('is_official', 1)->where('visible', 1);
    }

    public static function getAuthPrivateGames() {
        return auth()->user()->private_games->where('visible', 1)->where('is_public',  0)->where('is_official', 0);
    }
