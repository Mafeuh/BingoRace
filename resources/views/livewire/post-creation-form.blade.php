<x-main-panel class="text-center w-96">
    <x-form.label>
        {{ __('posts.new.title') }}
    </x-form.label>
    ...
    <button wire:click="preview" class="px-5 py-2 bg-gray-200 dark:bg-slate-800 dark:text-gray-200 rounded-full">Preview</button>
